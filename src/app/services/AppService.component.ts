...
export class AppService {
  ...
  getClasses(): Observable<ClassDto[]> {
    return this.http.get<ClassDto[]>(`${this.baseUrl}/classes`);
  }

  // GET CLASS BY ID
  getClassById(id: number): Observable<ClassDto> {
    return this.http.get<ClassDto>(`${this.baseUrl}/class/${id}`);
  }

  // ADD CLASS
  addClass(cls: ClassModel): Observable<any> {
    return this.http.post(`${this.baseUrl}/class`, cls);
  }

  // UPDATE CLASS
  updateClass(id: number, cls: ClassModel): Observable<any> {
    return this.http.put(`${this.baseUrl}/class/${id}`, cls);
  }
